...
public class TAConfigHandler 
{
   private FileConfiguration config;
   private final TeamAdvantage plugin;

   public TAConfigHandler(TeamAdvantage plugin) 
   {
      this.plugin = plugin;      
   ...
   public void reloadConfig(CommandSender sender)
   {
      ...
      sender.sendMessage(TeamAdvantage.logPrefix + plugin.getDescription().getName() + " " + plugin.getDescription().getVersion() + " reloaded!");       
   } 
}
